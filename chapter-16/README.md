# chapter-16 — Sealed Secrets and Vault as alternatives

Companion snapshot for Chapter 16 of *Cloud-Native Spring Boot*.
...
book's `cd chapter-16` commands work and so chapter-specific manifests,

# chapter-10 — Resource requests and limits done right

Companion snapshot for Chapter 10 of *Cloud-Native Spring Boot*.
...
book's `cd chapter-10` commands work and so chapter-specific manifests,

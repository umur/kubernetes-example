# chapter-14 — CloudNativePG: Postgres as a first-class operator

Companion snapshot for Chapter 14 of *Cloud-Native Spring Boot*.
...
book's `cd chapter-14` commands work and so chapter-specific manifests,
